...
async function getDownloadArticles(): Promise<Article[]> {
  const contentDir = path.join(process.cwd(), 'src/content/download')
...
export default async function DownloadPage() {
  const articles = await getDownloadArticles()

...
async function getBuildsArticles(): Promise<Article[]> {
  const contentDir = path.join(process.cwd(), 'src/content/builds')
...
export default async function BuildsPage() {
  const articles = await getBuildsArticles()
    ...
    <div className="container mx-auto py-12">
      ...
      <div className="flex flex-col justify-between items-center mb-6">
        <h1 className="mx-auto max-w-3xl text-3xl font-bold lg:text-5xl tracking-tight text-white drop-shadow-lg">
          <span className="pt-10">Character Builds</span>
        </h1>
        <h2 className="mx-auto max-w-[700px] md:text-xl my-6 text-gray-200 drop-shadow-md">
          Optimize your character with community-approved builds for every weapon and playstyle
        </h2>
      </div>

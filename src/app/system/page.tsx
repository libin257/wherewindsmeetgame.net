...
async function getSystemArticles(): Promise<Article[]> {
  const contentDir = path.join(process.cwd(), 'src/content/system')
...
export default async function SystemPage() {
  const articles = await getSystemArticles()
    ...
    <div className="container mx-auto py-12">
      ...
      <div className="flex flex-col justify-between items-center mb-6">
        <h1 className="mx-auto max-w-3xl text-3xl font-bold lg:text-5xl tracking-tight text-white drop-shadow-lg">
          <span className="pt-10">System & Technical</span>
        </h1>
        <h2 className="mx-auto max-w-[700px] md:text-xl my-6 text-gray-200 drop-shadow-md">
          System requirements, crossplay support, server status, and technical information
        </h2>
      </div>
